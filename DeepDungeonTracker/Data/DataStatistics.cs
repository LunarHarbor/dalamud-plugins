...
public class DataStatistics
{
    ...
    public bool IsEurekaOrthosFloor99 => this.DeepDungeon is DeepDungeon.EurekaOrthos or DeepDungeon.PilgrimsTraverse && this.FloorSetStatistics == FloorSetStatistics.From091To100;
    ...
    public void FloorSetStatisticsSummarySelection(int maxFloor, string floorSetTextSummary, ScoreCalculationType scoreCalculationType)
    {
        if (this.FloorSetTextSummary != floorSetTextSummary)
        {
            ...
            this.ScoreSummary?.TotalScoreCalculation(true, scoreCalculationType);
        }
        else
