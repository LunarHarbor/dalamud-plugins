...
#pragma warning restore CA1024
    ...
    public void Save(string key)
    {
        ...
        try { LocalStream.Save(ServiceUtility.ConfigDirectory, SaveSlotSelection.FileName, this.Data).GetAwaiter().GetResult(); }
        catch (System.Exception e) when (e is System.IO.IOException or System.UnauthorizedAccessException or System.Text.Json.JsonException)
        { CaptureDiagnostics.Report("Save slot selection failed", e); }
    }
}
