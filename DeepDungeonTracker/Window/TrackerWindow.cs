...
public sealed class TrackerWindow(string id, Configuration configuration, Data data) : WindowEx(id, configuration), IDisposable
{
    ...
    public override void Draw()
    {
        ...
        void Potsherds(float y, float columnX, float offsetX, SaveSlot saveSlot, FloorSet floorSet, Floor floor)
            => DrawTextLine(y, columnX, offsetX, CheckForDeepDungeon(DeepDungeon.PilgrimsTraverse) ? "Glass:" : CheckForDeepDungeon(DeepDungeon.EurekaOrthos) ? "Fragments:" : "Potsherds:", floor.Potsherds(), floorSet.Potsherds(), saveSlot.Potsherds());
